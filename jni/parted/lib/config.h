...
#define GNULIB_ACCEPT IN_PARTED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module bind shall be considered present. */
#define GNULIB_BIND IN_PARTED_GNULIB_TESTS
...
#define GNULIB_CONNECT IN_PARTED_GNULIB_TESTS
...
#define GNULIB_FDOPENDIR IN_PARTED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module fd-safer-flag shall be considered present. */
#define GNULIB_FD_SAFER_FLAG IN_PARTED_GNULIB_TESTS
...
#define GNULIB_FSTATAT IN_PARTED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module getcwd shall be considered present. */
#define GNULIB_GETCWD IN_PARTED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module ioctl shall be considered present. */
#define GNULIB_IOCTL IN_PARTED_GNULIB_TESTS
...
#define GNULIB_LISTEN IN_PARTED_GNULIB_TESTS
...
#define GNULIB_OPENAT IN_PARTED_GNULIB_TESTS
...
#define GNULIB_SELECT IN_PARTED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module setsockopt shall be considered present. */
#define GNULIB_SETSOCKOPT IN_PARTED_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module socket shall be considered present. */
#define GNULIB_SOCKET IN_PARTED_GNULIB_TESTS
...
#define PACKAGE_STRING "GNU parted 3.6.6-c5bd"
...
#define PACKAGE_VERSION "3.6.6-c5bd"
